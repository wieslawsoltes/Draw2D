    ...
    public class EllipseShape : ConnectableShape
    {
        ...
        public override bool Connect(IPointShape point, IPointShape target)
        {
            ...
            else if (CanConnect(point))
            {
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(EllipseShape)}: Connected to {nameof(TopLeft)}");
#endif
                    this.TopLeft = point;
                    return true;
                }
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(EllipseShape)}: Connected to {nameof(BottomRight)}");
#endif
        ...
        public override bool Disconnect(IPointShape point, out IPointShape result)
        {
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(EllipseShape)}: Disconnected from {nameof(TopLeft)}");
#endif
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(EllipseShape)}: Disconnected from {nameof(BottomRight)}");
#endif
                result = (IPointShape)(point.Copy(null));
