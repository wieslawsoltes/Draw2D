    ...
    public class RectangleShape : ConnectableShape
    {
        ...
        public override bool Connect(IPointShape point, IPointShape target)
        {
            ...
            else if (CanConnect(point))
            {
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(RectangleShape)}: Connected to {nameof(TopLeft)}");
#endif
                    this.TopLeft = point;
                    return true;
                }
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(RectangleShape)}: Connected to {nameof(BottomRight)}");
#endif
        ...
        public override bool Disconnect(IPointShape point, out IPointShape result)
        {
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(RectangleShape)}: Disconnected from {nameof(TopLeft)}");
#endif
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(RectangleShape)}: Disconnected from {nameof(BottomRight)}");
#endif
                result = (IPointShape)(point.Copy(null));
