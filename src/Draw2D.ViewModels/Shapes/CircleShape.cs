    ...
    public class CircleShape : BaseShape
    {
        ...
        public override bool Connect(IPointShape point, IPointShape target)
        {
            ...
            else if (CanConnect(point))
            {
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(CircleShape)}: Connected to {nameof(StartPoint)}");
#endif
                ...
                {
#if DEBUG_CONNECTORS
                    Log.WriteLine($"{nameof(CircleShape)}: Connected to {nameof(Point)}");
#endif
                    this.Point = point;
                    return true;
                }
        ...
        public override bool Disconnect(IPointShape point, out IPointShape result)
        {
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(CircleShape)}: Disconnected from {nameof(StartPoint)}");
#endif
            ...
            {
#if DEBUG_CONNECTORS
                Log.WriteLine($"{nameof(CircleShape)}: Disconnected from {nameof(Point)}");
#endif
                result = (IPointShape)(point.Copy(null));
                this.Point = result;
                return true;
